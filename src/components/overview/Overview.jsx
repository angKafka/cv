        ...
        <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
                <p className="text-lg leading-relaxed mb-6">
                    Highly skilled and results-driven Backend Developer with 5+ years of experience in architecting, developing, and optimizing scalable, event-driven microservices using Java, Spring Boot, and Kafka. Proven expertise in cloud platforms (GCP, Azure), CI/CD automation, and secure API development. Adept at enhancing system performance, ensuring distributed consistency, and collaborating with cross-functional teams to deliver robust enterprise solutions.
                </p>
            </div>
